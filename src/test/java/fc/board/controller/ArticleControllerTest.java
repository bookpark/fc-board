...
import fc.board.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @Test
    public void getListAndPaginationAndSortingTest() throws Exception {
        //given
    ...
    @Test
    public void getDetailTestWithNoAuthentication() throws Exception {
        // Given
        long articleId = 1L;
    ...
    @Test
    public void getHashtagSearchTest() throws Exception {
        //given
    ...
    @Test
    public void getHashtagSearchWithParamTest() throws Exception {
        //given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
    ...
    @WithUserDetails(value = "bookTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
